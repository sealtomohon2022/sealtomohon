...
<div class="row">
  ...
  <div class="col-3 mb-3">
    ...
    <button type="button" class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#formtambahpanganmodal">
...
<div class="col-3">
  <a href="action/toexcel.php" class="btn btn-secondary">
    <ion-icon name="document-text-outline"></ion-icon>Ekspor ke Excel
  </a>
</div>
<!-- akhir to excel -->
...
<!-- to pdf -->
<!-- <div class="col-3">
  <a href="action/topdf.php" class="btn btn-secondary">
    <ion-icon name="document-text-outline"></ion-icon>Ekspor ke pdf
  </a>
</div> -->
<!-- akhir to pdf -->
            ...
            <tr>
              ...
              <td class=""><?php
                ...
                ?>
                  ...
                  <div class=" mb-0 text-success d-flex ms-5">
                    <ion-icon name="arrow-down-outline" class="fs-3 text-start"></ion-icon>
                ...
                ?>
                  ...
                  <div class="mb-0 text-dark d-flex ms-5">
                    <ion-icon name="reorder-two-outline" class="fs-3 mt-1"></ion-icon>
